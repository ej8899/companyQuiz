    ...
    <section className="bg-white dark:bg-gray-900 h-full items-center justify-center flex">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-sm text-center">
                ...
                <Button href="#" className="inline-flex text-white bg-primary-600 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300  rounded-lg text-lg px-5 py-2.5 text-center dark:focus:ring-primary-900 my-4">Back to Homepage</Button>
            </div>   
        </div>
    </section>
  );
